...
/**
 * Class BrlToPlnStrategy
 */
final class BrlToPlnStrategy implements ExchangeRateStrategyInterface
{
    /**
     * @var float
     */
    ...
    {
        $this->exchangeRate->setFrom(CurrencyConfig::BRL);
    }
    ...
    {
        return CurrencyConfig::BRL === $from && CurrencyConfig::PLN === $to;
    }
